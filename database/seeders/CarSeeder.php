...
class CarSeeder extends Seeder
{
    public function run()
    {
        Car::create([
            ...
            'description' => 'Foi fabricado pela primeira vez em 1966, sendo lançado no mercado em 1967, é fabricado nos Estados Unidos. Historicamente, a produção do Camaro tem ocorrido em várias fábricas nos EUA, incluindo a planta da General Motors em Norwood, Ohio, e Van Nuys, Califórnia. O nome "Camaro" foi escolhido pela Chevrolet e, segundo a lenda, significa "amigo" ou "camarada" em francês, embora essa tradução seja disputada. As opções de motor incluíam desde um seis cilindros em linha de 3,8 litros até motores V8 de alto desempenho, como o 5,7 litros (350 ci) e o 6,5 litros (396 ci). O lançamento do Camaro foi acompanhado de uma campanha publicitária massiva pela Chevrolet, destacando-o como um "pony car" com muitas opções de personalização e desempenho, competindo diretamente com o Ford Mustang. Em seu primeiro ano de produção, o Camaro vendeu mais de 220.000 unidades, demonstrando seu forte apelo no mercado norte-americano.',
            'preco_diaria' => 300.00,
        ...
        Car::create([
            ...
            'year' => 1973,
            'country' => 'Brasil',
            'description' => 'Foi fabricado pela primeira vez em 1973 (no Brasil), mercado mundial como nos Estados Unidos, o Chevette foi fabricado de 1975 a 1987. O Chevette foi oferecido com várias opções de motor, incluindo 1.4, 1.6, 1.6 álcool, é uma versão diesel de 1.8 litros, o Chevette Junior. O Chevette teve uma presença significativa no automobilismo, especialmente em rallys e corridas de turismo, devido à sua leveza e simplicidade mecânica. Conhecido por sua durabilidade e robustez, o Chevette era popular entre taxistas e motoristas de frota, que precisavam de um veículo confiável e de fácil manutenção.',
            'preco_diaria' => 350.00,
        ...
        Car::create([
            ...
            'year' => 1982,
            'country' => 'Brasil',
            'description' => 'Teve sua produção iniciada em 1982 em diferentes países ao redor do mundo, com variações regionais para atender às necessidades específicas dos mercados locais, a S10 é produzida principalmente no Brasil ,ela foi uma das primeiras picapes compactas a serem produzidas no Brasil, introduzida em 1995 para competir no segmento de picapes médias. Desde então, tornou-se um dos modelos mais populares em seu segmento, conhecida por sua robustez, versatilidade e desempenho, sendo frequentemente escolhida tanto por consumidores individuais quanto por empresas comerciais.',
            'preco_diaria' => 260.00,
        ...
        Car::create([
            ...
            'year' => 1960,
            'country' => 'Estados Unidos',
            'description' => 'Foi fabricado pela primeira vez em 1960, produzido principalmente nos Estados Unidos, nas fábricas da Dodge em diferentes localidades. O Dodge Dart foi lançado como um modelo full-size em 1960, mas ao longo do tempo, evoluiu para se tornar um carro compacto nas décadas de 1960 e 1970. Além de suas variantes de rua, o Dart teve sucesso nas corridas de arrancada e em outras competições automobilísticas, destacando-se na NHRA (National Hot Rod Association) por sua velocidade e desempenho.',
            'preco_diaria' => 400.00,
        ...
        Car::create([
            ...
            'year' => 1962,
            'country' => 'Canadá',
            'description' => 'A produção começou na década de 1930 e continuou até a década de 1970 foi produzida principalmente no Canadá, apesar de ser uma linha de caminhões rebatizada da Dodge, ela desempenhou um papel significativo no mercado canadense. Os caminhões Fargo eram populares entre os agricultores, trabalhadores da construção e empresas de entrega no Canadá devido à sua confiabilidade e durabilidade. Eles se tornaram uma parte importante da paisagem automotiva do país e continuam a ser lembrados com carinho por muitos canadenses até hoje.',
            'preco_diaria' => 370.00,
        ...
        Car::create([
            ...
            'year' =>  1950,
            'country' => 'Brasil',
            'description' => 'A Volkswagen Kombi foi fabricada por várias décadas, desde 1950 até 2013, produzida em diferentes países ao redor do mundo, mas sua produção mais significativa ocorreu no Brasil. A Kombi foi fabricada na fábrica da Volkswagen em São Bernardo do Campo, no estado de São Paulo, Brasil, a Volkswagen Kombi é que ela foi um dos veículos mais versáteis e duráveis já produzidos. Conhecida por sua capacidade de transporte de carga e passageiros, a Kombi se tornou um símbolo de aventura e liberdade. Além disso, sua popularidade foi impulsionada pelo seu papel como veículo de transporte escolar, ambulância, van de entrega e até mesmo como um lar sobre rodas para muitas pessoas ao redor do mundo. A Kombi também teve um impacto significativo na cultura popular, sendo apresentada em filmes, músicas e obras de arte, deixando um legado duradouro como um ícone automotivo.',
            'preco_diaria' => 200.00,
